...
import com.iw.common.core.service.RemoteUserFallbackFactory;
 ...
 * @author ruoyi
 */
@FeignClient(contextId = "remoteUserService", value = ServiceNameConstants.VIEW_SERVICE, fallbackFactory = RemoteUserFallbackFactory.class)
